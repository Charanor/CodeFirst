...
public class ShaderClassGenerator
{
	...
	private const string MATERIAL_CLASS = "CodeFirst.Graphics.Core.Material";
	...
	private void BuildClass(ClassBuilder classBuilder)
	{
		classBuilder.IndentedLn(
			$@"[GeneratedCode({Quote("CodeFirst.Generators")}, {Quote(GENERATOR_VERSION)})]");
	...
	{
		classBuilder.IndentedLn("namespace CodeFirst.Graphics.Generated;");
		classBuilder.NewLine();
	}
