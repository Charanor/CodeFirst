...
{
	private const string ATTRIBUTE_NAMESPACE = "CodeFirst.Ecs.Core.Attributes.Generation";
	...
	private const string COMPONENT_METADATA_NAME = "CodeFirst.Ecs.Core.IComponent";
	private const string SINGLETON_COMPONENT_METADATA_NAME = "CodeFirst.Ecs.Core.ISingletonComponent";
	private const string ITERATING_SYSTEM_METADATA_NAME = "CodeFirst.Ecs.Core.IteratingSystem";
