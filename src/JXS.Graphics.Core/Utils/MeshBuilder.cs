...
public class MeshBuilder
{
	...
	public Mesh Cube(float width, float height, float length, Material material)
	{
		...
		{
			new(backward1.P1, backward1.Normal, Vector2.Zero),
			new(backward1.P2, backward1.Normal, Vector2.Zero),
			new(backward1.P3, backward1.Normal, Vector2.Zero),

			new(backward2.P1, backward2.Normal, Vector2.Zero),
			new(backward2.P2, backward2.Normal, Vector2.Zero),
			new(backward2.P3, backward2.Normal, Vector2.Zero),

			new(forward1.P1, forward1.Normal, Vector2.Zero),
			new(forward1.P2, forward1.Normal, Vector2.Zero),
			new(forward1.P3, forward1.Normal, Vector2.Zero),

			new(forward2.P1, forward2.Normal, Vector2.Zero),
			new(forward2.P2, forward2.Normal, Vector2.Zero),
			new(forward2.P3, forward2.Normal, Vector2.Zero),

			new(left1.P1, left1.Normal, Vector2.Zero),
			new(left1.P2, left1.Normal, Vector2.Zero),
			new(left1.P3, left1.Normal, Vector2.Zero),

			new(left2.P1, left2.Normal, Vector2.Zero),
			new(left2.P2, left2.Normal, Vector2.Zero),
			new(left2.P3, left2.Normal, Vector2.Zero),

			new(right1.P1, right1.Normal, Vector2.Zero),
			new(right1.P2, right1.Normal, Vector2.Zero),
			new(right1.P3, right1.Normal, Vector2.Zero),

			new(right2.P1, right2.Normal, Vector2.Zero),
			new(right2.P2, right2.Normal, Vector2.Zero),
			new(right2.P3, right2.Normal, Vector2.Zero),

			new(bottom1.P1, bottom1.Normal, Vector2.Zero),
			new(bottom1.P2, bottom1.Normal, Vector2.Zero),
			new(bottom1.P3, bottom1.Normal, Vector2.Zero),

			new(bottom2.P1, bottom2.Normal, Vector2.Zero),
			new(bottom2.P2, bottom2.Normal, Vector2.Zero),
			new(bottom2.P3, bottom2.Normal, Vector2.Zero),

			new(top1.P1, top1.Normal, Vector2.Zero),
			new(top1.P2, top1.Normal, Vector2.Zero),
			new(top1.P3, top1.Normal, Vector2.Zero),

			new(top2.P1, top2.Normal, Vector2.Zero),
			new(top2.P2, top2.Normal, Vector2.Zero),
			new(top2.P3, top2.Normal, Vector2.Zero)
		};
