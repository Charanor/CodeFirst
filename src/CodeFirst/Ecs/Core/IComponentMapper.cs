...
public interface IComponentMapper
{
	...
	public IComponent Update(Entity entity, in IComponent component);
...
public interface IComponentMapper<T> where T : IComponent
{
	public int ComponentId { get; }
	...
	/// <param name="entity">the entity id</param>
	/// <param name="component">the component to update values for</param>
	public ref T Update(Entity entity, in T component);
	...
	/// <param name="component">the component to add</param>
	/// <returns>the component</returns>
	public ref T AddIfMissing(Entity entity, in T component);
